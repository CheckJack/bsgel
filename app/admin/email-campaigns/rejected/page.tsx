        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              View and manage rejected email campaigns
            </p>
          </div>
        </div>
                  ...
                  <div className="space-y-4">
                    {campaign.reviewComments && (
                      <div className="mb-3 p-3 bg-red-50 dark:bg-red-900/20 rounded text-sm text-gray-900 dark:text-gray-100 border border-red-200 dark:border-red-800">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">{campaign.reviewComments}</p>
                      </div>
                    )}
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                      ...
                      <div className="flex items-center gap-1">
                        <Clock className="h-3 w-3" />
                        <span>Rejected: {formatDate(campaign.updatedAt)}</span>
                      </div>
                    </div>
