    ...
    try {
      ...
      if (image.file) {
        ...
        reader.onloadend = async () => {
          ...
          await createCategory(base64String);
        };
        reader.onerror = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Category information</h1>
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Dashboard <span className="mx-2">&gt;</span> Category{" "}
          <span className="mx-2">&gt;</span> New category
        </div>
      </div>
