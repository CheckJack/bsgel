      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-4xl font-medium mb-6 text-brand-black">Send us a Message</h2>
              <div className="w-24 h-1 bg-brand-champagne mb-8"></div>
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-4xl font-medium mb-6 text-brand-black">Get in Touch</h2>
              <div className="w-24 h-1 bg-brand-champagne mb-8"></div>
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-medium mb-3 text-brand-black">General Inquiries</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-3 text-brand-black">Customer Support</h3>
                  <p className="font-light text-brand-champagne leading-relaxed mb-2">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-3 text-brand-black">Training & Education</h3>
                  <p className="font-light text-brand-champagne leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-3 text-brand-black">Find a Salon</h3>
                  ...
                  <a
                    href="/salons"
                    className="inline-block px-6 py-2 bg-brand-black text-brand-white hover:bg-brand-champagne transition-colors font-medium rounded"
                  >
                    Find a Salon
                  </a>
                </div>
      ...
      <section className="py-16 px-4 bg-brand-sweet-bianca">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-medium mb-4 text-brand-black">Additional Resources</h2>
