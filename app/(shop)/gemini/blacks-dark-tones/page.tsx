...
export default function BlacksDarkTonesPage() {
  ...
  const slides = [
    {
      ...
      title: "Blacks / Dark tones",
      description: "Discover our sophisticated collection of Black and Dark tone shades",
    },
  ];
  ...
  const fetchProducts = async () => {
    setIsLoading(true);
    try {
      const res = await fetch(`/api/products?search=gemini black dark`);
      if (res.ok) {
  ...
  const ingredients = [
    ...
    },
    {
      ...
      name: "Passion Fruit",
      image: "/fawa.png",
      whyWeUseIt: "The seed oil is rich in linoleic and oleic acids plus vitamins A and E, so it delivers nourishing, moisturising and soothing effects while staying very light in texture.",
      benefits: [],
    ...
    },
    {
      ...
      name: "Ginseng Root",
      image: "/jojoba (6).png",
      whyWeUseIt: "Ginseng root extract helps stimulate local micro-circulation, so more oxygen and nutrients reach the nail matrix and surrounding skin, which can support better nail growth quality.",
      benefits: [],
        ...
        <div className="w-full h-full flex items-center">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center">
              <TextGenerateEffect
                words="Blacks and Dark tones represent ultimate sophistication and edge in our Gemini collection. From classic black to deep charcoal and rich dark grays, these shades offer powerful options for those who prefer bold, dramatic looks. Each gel delivers intense, opaque color with smooth application and exceptional durability. Whether you choose a pure black, a deep navy, or a rich dark brown, our collection ensures your nails make a striking statement with timeless elegance. #our-funds"
