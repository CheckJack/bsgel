...
export default function OrangesCoralsYellowsPage() {
  ...
  const slides = [
    {
      ...
      title: "Oranges & Corals / Yellows",
      description: "Discover our vibrant collection of Orange, Coral, and Yellow shades",
    },
  ];
  ...
  const fetchProducts = async () => {
    setIsLoading(true);
    try {
      const res = await fetch(`/api/products?search=gemini orange coral yellow`);
      if (res.ok) {
