...
export default function PinksPage() {
  ...
  const fetchPinkProducts = async () => {
    setIsLoading(true);
    try {
      // Fetch products assigned to pinks showcasing section with pagination
      const res = await fetch(`/api/products?showcasingSection=pinks&page=${currentPage}&limit=10`);
      if (res.ok) {
        ...
        <div className="w-full h-full flex items-center">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center">
              <TextGenerateEffect
                words={`${t("productPagesExtended.geminiPinks.description")} #our-funds`}
