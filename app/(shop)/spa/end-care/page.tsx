...
export default function EndCarePage() {
  ...
  const slides = [
    {
      ...
      title: "End Care",
      description: "Discover our premium End Care collection",
    },
  ];

  useEffect(() => {
    fetchEndCareProducts();
  }, []);
  ...
  const fetchEndCareProducts = async () => {
    setIsLoading(true);
    try {
      // Search for products with "end care" or "cuticle" in the name
      const res = await fetch(`/api/products?search=end care`);
      if (res.ok) {
  ...
  return (
    <>
        ...
        <div className="w-full h-full flex items-center">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center">
              <TextGenerateEffect
                words="End Care products are specifically formulated to nourish and protect the delicate cuticle area and nail tips. Our specialized treatments address common concerns like dry cuticles, hangnails, and brittle nail ends, providing intensive hydration and strengthening where your nails need it most. Each product in our End Care collection combines therapeutic ingredients with luxurious textures to deliver professional-grade care that keeps your nail tips healthy, strong, and beautifully maintained. #our-funds"
      ...
      {/* End Care Products Grid Section */}
      <section ref={productsSectionRef} className="relative w-full min-h-screen bg-brand-white py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">No End Care products found.</p>
            </div>
          ) : (
