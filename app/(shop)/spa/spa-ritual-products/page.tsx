...
export default function SpaRitualProductsPage() {
  ...
  const slides = [
    {
      ...
      title: "Spa Ritual Products",
      description: "Discover our premium Spa Ritual Products collection",
    },
  ];

  useEffect(() => {
    fetchSpaRitualProducts();
  }, []);
  ...
  const fetchSpaRitualProducts = async () => {
    setIsLoading(true);
    try {
      // Search for products with "spa ritual" or "ritual" in the name
      const res = await fetch(`/api/products?search=spa ritual`);
      if (res.ok) {
  ...
  return (
    <>
        ...
        <div className="w-full h-full flex items-center">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center">
              <TextGenerateEffect
                words="Spa Ritual Products are designed to transform your nail and hand care routine into a complete wellness experience. Our curated collection combines multiple products to create luxurious, therapeutic rituals that nourish, protect, and rejuvenate. Each ritual is thoughtfully crafted to provide a holistic approach to nail and hand care, incorporating exfoliation, hydration, and protection in a harmonious sequence. Experience the art of self-care with our Spa Ritual Products, designed to elevate your daily routine into a moment of pure indulgence and wellness. #our-funds"
      ...
      {/* Spa Ritual Products Grid Section */}
      <section ref={productsSectionRef} className="relative w-full min-h-screen bg-brand-white py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">No Spa Ritual Products found.</p>
            </div>
          ) : (
